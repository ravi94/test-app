...
object ErrorCodes {
    ...
    const val INVALID_MONTH_FORMAT = "INVALID_MONTH_FORMAT"
    const val FLAT_ALREADY_OCCUPIED = "FLAT_ALREADY_OCCUPIED"
    const val TENANT_NOT_FOUND = "TENANT_NOT_FOUND"
    const val BILLING_BEFORE_START_MONTH = "BILLING_BEFORE_START_MONTH"
    const val PREVIOUS_METER_READING_NOT_FOUND = "PREVIOUS_METER_READING_NOT_FOUND"
    const val INVALID_METER_READING = "INVALID_METER_READING"
}
